...
void PWM_Init(void)
{
  ...
  //connect the pin to the desired peripherals' Alternate Function (AF) - TIM4 (GPIO_AF_2)
  ...
  //for other channels this would be changed to TIM_OC2Init..., or TIM_OC3Init etc.
