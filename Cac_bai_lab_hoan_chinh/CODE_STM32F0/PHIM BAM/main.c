...
void gpio_setup(void)
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3 | GPIO_Pin_2 | GPIO_Pin_1 | GPIO_Pin_0;// dung PC9,PC8,PC7,PC1,PC0
...
{
    gpio_setup();
    GPIOC->ODR=0x0000; //PC8=0; Pc9=0  “GPIOC->ODR tương đương với thanh ghi GPIOC_ODR .nó là thanh ghi uotput GPIO->ODR, vị trí bit tương ứng với vị trí chân trên chip.ví dụ muốn cho PC8=1 PC9 =0 : GPIOC->ODR=0x0100;”
while(1)
    {
...
dem++;
if(dem==1) GPIOC->ODR=0x0001;//PC0=1
if(dem==2) GPIOC->ODR=0x0002;//PC1=1
if(dem==3) GPIOC->ODR=0x0004;//PC2=1
if(dem==4) GPIOC->ODR=0x0008;//PC3=1
if(dem==5) GPIOC->ODR=0x0004;//PC2=1
if(dem==6) GPIOC->ODR=0x0002;//PC1=1
if(dem==7) GPIOC->ODR=0x0001;//PC0=1
        }
    }
}
